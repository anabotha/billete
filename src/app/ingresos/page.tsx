...
const obtenerMovimientosQuery = useQuery(api.movimientos.obtenerMovimientos);
const movimientos = obtenerMovimientosQuery || [];
const crearMovimiento = useMutation(api.movimientos.crearMovimiento);
const metas = useQuery(api.metas.obtenerMetas)
const proyectos = useQuery(api.proyectos.obtenerProyectos)
console.log()
const guardarMovimiento = async () => {
 ...
 await crearMovimiento({
  ...
  metaId: tipo === "egreso" || tipo === "ahorro"
    ? destino as Id<"metas">
    : undefined,
})
